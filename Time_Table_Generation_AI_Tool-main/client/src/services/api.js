...
export const createTeacher = async (teacherData, options = {}) => {
  const response = await api.post('/data/teachers', { ...teacherData, ...options })
  return response.data
}

export const updateTeacher = async (id, teacherData, options = {}) => {
  const response = await api.put(`/data/teachers/${id}`, { ...teacherData, ...options })
  return response.data
}

export const deleteTeacher = async (id, options = {}) => {
  const response = await api.delete(`/data/teachers/${id}`, { params: options })
  return response.data
}
...
export const createClassroom = async (classroomData, options = {}) => {
  const response = await api.post('/data/classrooms', { ...classroomData, ...options })
  return response.data
}

export const updateClassroom = async (id, classroomData, options = {}) => {
  const response = await api.put(`/data/classrooms/${id}`, { ...classroomData, ...options })
  return response.data
}

export const deleteClassroom = async (id, options = {}) => {
  const response = await api.delete(`/data/classrooms/${id}`, { params: options })
  return response.data
}
...
export const createCourse = async (courseData, options = {}) => {
  const response = await api.post('/data/courses', { ...courseData, ...options })
  return response.data
}

export const updateCourse = async (id, courseData, options = {}) => {
  const response = await api.put(`/data/courses/${id}`, { ...courseData, ...options })
  return response.data
}

export const deleteCourse = async (id, options = {}) => {
  const response = await api.delete(`/data/courses/${id}`, { params: options })
  return response.data
}
...
export const createProgram = async (programData, options = {}) => {
  const response = await api.post('/data/programs', { ...programData, ...options })
  return response.data
}

export const updateProgram = async (id, programData, options = {}) => {
  const response = await api.put(`/data/programs/${id}`, { ...programData, ...options })
  return response.data
}

export const deleteProgram = async (id, options = {}) => {
  const response = await api.delete(`/data/programs/${id}`, { params: options })
  return response.data
}
...
export const createDivision = async (divisionData, options = {}) => {
  const response = await api.post('/data/divisions', { ...divisionData, ...options })
  return response.data
}

export const updateDivision = async (id, divisionData, options = {}) => {
  const response = await api.put(`/data/divisions/${id}`, { ...divisionData, ...options })
  return response.data
}

export const deleteDivision = async (id, options = {}) => {
  const response = await api.delete(`/data/divisions/${id}`, { params: options })
  return response.data
}
...
export const createTimetableSession = async (sessionData) => {
  const response = await api.post('/timetable-sessions', sessionData)
  return response.data
}

export const getTimetableSessions = async () => {
  const response = await api.get('/timetable-sessions')
  return response.data
}

export const getTimetableSession = async (id) => {
  const response = await api.get(`/timetable-sessions/${id}`)
  return response.data
}

export const updateTimetableSession = async (id, sessionData) => {
  const response = await api.patch(`/timetable-sessions/${id}`, sessionData)
  return response.data
}

export const deleteTimetableSession = async (id) => {
  const response = await api.delete(`/timetable-sessions/${id}`)
  return response.data
}

// Session-based timetable generation (new unified endpoint)
export const generateTimetableSession = async (sessionId, selectedAlgorithm, constraints = {}) => {
