...
const timetableSessionRoutes = require('./routes/timetableSession');
const timetableGenerateRoutes = require('./routes/timetable');
...
app.use('/api/timetable-sessions', timetableSessionRoutes);
app.use('/api/timetable', timetableGenerateRoutes);
