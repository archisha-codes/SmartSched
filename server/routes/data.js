...
router.get('/teachers', [
  ...
  try {
    ...
    const { department, status, subject, sessionId, page = 1, limit = 50 } = req.query;
...
router.post('/teachers', [
  ...
  try {
    ...
    if (req.body.sessionId) {
      teacherData.sessionId = req.body.sessionId;
    }
...
router.put('/teachers/:id', [
  ...
  try {
    ...
    if (req.body.sessionId) {
      teacher.sessionId = req.body.sessionId;
    }
...
router.get('/classrooms', [
  ...
  try {
    ...
    const { building, type, status, minCapacity, features, sessionId, page = 1, limit = 50 } = req.query;
...
router.post('/classrooms', [
  ...
  try {
    ...
    if (req.body.sessionId) {
      classroomData.sessionId = req.body.sessionId;
    }
...
router.get('/courses', [
  ...
  try {
    ...
    const { department, program, year, semester, teacher, isActive, sessionId, page = 1, limit = 50 } = req.query;
...
router.post('/courses', [
  ...
  try {
    ...
    if (req.body.sessionId) {
      courseData.sessionId = req.body.sessionId;
    }
...
router.post('/students', [
  ...
  try {
    ...
    if (req.body.sessionId) {
      studentData.sessionId = req.body.sessionId;
    }
...
router.get('/programs', [
  ...
  try {
    ...
    const { school, type, status, sessionId, page = 1, limit = 50 } = req.query;
...
router.post('/programs', [
  ...
  try {
    ...
    if (req.body.sessionId) {
      programData.sessionId = req.body.sessionId;
    }
...
router.get('/holidays', [
  ...
  try {
    ...
    const { type, status, sessionId, page = 1, limit = 50 } = req.query;
...
router.post('/holidays', [
  ...
  try {
    ...
    if (req.body.sessionId) {
      holidayData.sessionId = req.body.sessionId;
    }
